# VIDEO 04 - POST, PUT y DELETE con SQL

En este vídeo hemos ampliado nuestro controlador de languages para que soporte POST, PUT y DELETE.

Los métodos han quedado así:
